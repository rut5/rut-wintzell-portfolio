  ...
  return (
    ...
    <>
      ...
      <p>On this page, you can view some of my projects.
        Use the search button to find projects by specific methods or technologies.
        If you want to learn more about me and my work, feel free to check out the 'About Me' page!</p>
      <button className="btn" onClick={showProjects}>{view ? 'Hide my projects' : 'View my projects'}</button>
{/* 
      {view && (
